...
@Generated(value = "org.mapstruct.ap.MappingProcessor", date = "2023-10-05T19:39:23+0800", comments = "version: 1.5.3.Final, compiler: javac, environment: Java 1.8.0_271 (Oracle Corporation)")
@Component
public class ClusterMapperImpl implements ClusterMapper {
	...
	@Override
	public ClusterEntity updateEngineReqToClusterEntity(UpdateClusterReq caeUpdateEngineReq,
	...
	public PageClusterRes clusterEntityToPageClusterRes(ClusterEntity clusterEntity) {
		...
		if (clusterEntity.getCheckDateTime() != null) {
			pageClusterRes.setCheckDateTime(
					dateTimeFormatter_yyyy_MM_dd_HH_mm_ss_11333195168.format(clusterEntity.getCheckDateTime()));
		}
