...
@Generated(value = "org.mapstruct.ap.MappingProcessor", date = "2023-10-05T19:39:24+0800", comments = "version: 1.5.3.Final, compiler: javac, environment: Java 1.8.0_271 (Oracle Corporation)")
@Component
public class TenantMapperImpl implements TenantMapper {

	private final DateTimeFormatter dateTimeFormatter_yyyy_MM_dd_HH_mm_ss_11333195168 = DateTimeFormatter
	...
	@Override
	public TenantEntity tetUpdateTenantBySystemAdminReqToTenantEntity(
	...
	@Override
	public TenantEntity tetUpdateTenantByTenantAdminReqToTenantEntity(
	...
	public PageTenantRes tenantEntityToTetQueryTenantRes(TenantEntity tenantEntity) {
		...
		if (tenantEntity.getCheckDateTime() != null) {
			pageTenantRes.setCheckDateTime(
					dateTimeFormatter_yyyy_MM_dd_HH_mm_ss_11333195168.format(tenantEntity.getCheckDateTime()));
		}
