...
public class ClusterNodeMapperImpl implements ClusterNodeMapper {
	...
	@Override
	public ClusterNodeEntity updateNodeReqToNodeEntity(UpdateClusterNodeReq enoUpdateNodeReq,
	...
	public EnoQueryNodeRes nodeEntityToQueryNodeRes(ClusterNodeEntity nodeEntity) {
		...
		if (nodeEntity.getCheckDateTime() != null) {
			enoQueryNodeRes.setCheckDateTime(
					dateTimeFormatter_yyyy_MM_dd_HH_mm_ss_11333195168.format(nodeEntity.getCheckDateTime()));
		}
