...
public class WorkMapperImpl implements WorkMapper {
	...
	public PageWorkRes workEntityToPageWorkRes(WorkEntity workEntity) {
		...
		if (workEntity.getCreateDateTime() != null) {
			pageWorkRes.setCreateDateTime(
					dateTimeFormatter_yyyy_MM_dd_HH_mm_ss_11333195168.format(workEntity.getCreateDateTime()));
		}
	...
	@Override
	public GetWorkRes workEntityAndWorkConfigEntityToGetWorkRes(WorkEntity workEntity,
