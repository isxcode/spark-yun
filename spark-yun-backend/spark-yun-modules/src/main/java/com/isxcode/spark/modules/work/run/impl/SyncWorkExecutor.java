...
// clusterNodeRepository.findAllByClusterIdAndStatus(clusterOpt.get().getId(),
...
// clusterNodeRepository.findById(workEventBody.getEngineNodeId()).orElseThrow(
...
// if (workEventBody.getStatus() == null ||
// !successStatus.contains(workEventBody.getStatus().toUpperCase())) {
