...
import com.isxcode.spark.api.workflow.dto.NodeInfo;
import com.isxcode.spark.backend.api.base.exceptions.IsxAppException;
import com.isxcode.spark.common.utils.jgrapht.JgraphtUtils;
...
public class WorkflowUtils {
    ...
    public static WorkRunContext genWorkRunContext(String instanceId, String eventType, WorkEntity work,
        ...
        return WorkRunContext.builder().datasourceId(workConfig.getDatasourceId()).script(workConfig.getScript())
            ...
            .apiSyncConfig(JSON.parseObject(workConfig.getApiSyncConfig(), ApiSyncConfig.class))
    ...
    public static WorkRunContext genWorkRunContext(String instanceId, String eventType, WorkEntity work,
        ...
        return WorkRunContext.builder().datasourceId(workVersion.getDatasourceId()).script(workVersion.getScript())
            ...
            .queryConfig(JSON.parseObject(workVersion.getQueryConfig(), QueryConfig.class))
            ...
            .apiSyncConfig(JSON.parseObject(workVersion.getApiSyncConfig(), ApiSyncConfig.class))
