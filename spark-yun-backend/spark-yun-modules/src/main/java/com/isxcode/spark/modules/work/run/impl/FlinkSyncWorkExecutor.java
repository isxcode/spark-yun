...
@Service
public class FlinkSyncWorkExecutor extends SyncWorkExecutor {

    public FlinkSyncWorkExecutor(WorkInstanceRepository workInstanceRepository, ClusterRepository clusterRepository,
    ...
    public String getWorkType() {
        return WorkType.DATA_SYNC_FLINK;
    }
}
