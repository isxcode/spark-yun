...
// AlarmService alarmService, SqlFunctionService sqlFunctionService, WorkEventRepository
// workEventRepository,
// Scheduler scheduler, WorkRunJobFactory workRunJobFactory, VipWorkVersionRepository
...
//
// // 获取作业运行上下文
// CurlExecutorContext workEventBody = JSON.parseObject(workEvent.getEventContext(),
// CurlExecutorContext.class);
