...
public abstract class WorkExecutor {
    ...
    public String updateWorkEventAndInstance(WorkInstanceEntity workInstance, StringBuilder logBuilder, WorkEventEntity workEvent, WorkRunContext workRunContext) {
