...
//
// public DatabaseMigratorExecutor(WorkInstanceRepository workInstanceRepository, ClusterRepository
// clusterRepository,
...
// Optional<ClusterEntity> engineOpt =
// clusterRepository.findById(workRunContext.getClusterConfig().getClusterId());
// Optional<ClusterNodeEntity> engineNodeOpt =
// clusterNodeRepository.findById(workEventBody.getNodeId());
