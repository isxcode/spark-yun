...
// submitWorkReq.setAgentHomePath(agentNode.getAgentHomePath() + "/" +
...
// GetWorkStatusReq.builder().appId(appId).clusterType(clusterType)
// .sparkHomePath(agentNode.getSparkHomePath()).build();
// BaseResponse<?> baseResponse = HttpUtils.doPost(httpUrlUtils.genHttpUrl(agentNode.getHost(),
// agentNode.getAgentPort(), SparkAgentUrl.GET_WORK_STATUS_URL), getWorkStatusReq,
// BaseResponse.class);
// if (!String.valueOf(HttpStatus.OK.value()).equals(baseResponse.getCode())) {
...
// .sparkHomePath(agentNode.getSparkHomePath()).build();
// baseResponse = HttpUtils.doPost(httpUrlUtils.genHttpUrl(agentNode.getHost(),
// agentNode.getAgentPort(),
