...
// alarmService,
// DatasourceMapper datasourceMapper, DataSourceFactory dataSourceFactory, SecretKeyRepository
// secretKeyRepository,
...
// workEventBody.setPrintScript(printSql);
...
// String printSql = workEventBody.getPrintScript();
//
// // 获取集群和节点信息
...
//
// // 当前状态变化保存
// String currentStatus = workEventBody.getCurrentStatus() != null ?
// workEventBody.getCurrentStatus() : "";
// if (!currentStatus.equals(workStatusRes.getAppStatus())) {
...
//
// /**
// * SparkSql执行器上下文，用于保存执行过程中的状态信息
// */
// @Data
// @Builder
// @NoArgsConstructor
// @AllArgsConstructor
// public static class SparkSqlExecutorContext {
