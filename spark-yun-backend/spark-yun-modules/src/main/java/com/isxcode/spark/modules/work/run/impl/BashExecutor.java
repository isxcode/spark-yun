...
//
// // 获取日志
// String getLogCommand = "cat " + agentHomePath + "/zhiqingyun-agent/works/" + workInstance.getId()
// + ".log";
// String logCommand;
// try {
...
// // 删除脚本和日志
// try {
// String clearWorkRunFile = "rm -f " + agentHomePath + "/zhiqingyun-agent/works/" +
// workInstance.getId()
// + ".log && " + "rm -f " + agentHomePath + "/zhiqingyun-agent/works/" + workInstance.getId() +
// ".sh";
