package com.isxcode.spark.modules.view.mapper;

import com.isxcode.spark.api.view.dto.CardInfo;
import com.isxcode.spark.api.view.req.AddViewCardReq;
import com.isxcode.spark.api.view.req.AddViewReq;
import com.isxcode.spark.api.view.res.AddViewRes;
import com.isxcode.spark.api.view.res.GetViewLinkInfoRes;
import com.isxcode.spark.api.view.res.PageViewCardRes;
import com.isxcode.spark.api.view.res.PageViewRes;
