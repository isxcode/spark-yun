...
public interface WorkflowMapper {
  ...
  List<PageWorkflowRes> workflowEntityListToQueryWorkflowResList(
      List<WorkflowEntity> workflowEntities);

  default Page<PageWorkflowRes> workflowEntityPageToQueryWorkflowResPage(
      Page<WorkflowEntity> workflowEntityPage) {
    List<PageWorkflowRes> dtoList =
