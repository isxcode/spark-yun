...
public class AddWorkReq {
    ...
    @Pattern(
        regexp = "^(SPARK_SQL|EXE_JDBC|QUERY_JDBC|DATA_SYNC_JDBC|BASH|PYTHON|SPARK_JAR|SPARK_CONTAINER_SQL|API|PRQL|CURL|EXCEL_SYNC_JDBC|PY_SPARK|DB_MIGRATE|FLINK_SQL|FLINK_JAR|SPARK_ETL)$",
        message = "作业类型不支持")
