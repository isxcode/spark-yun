...
public class AesUtils {
  ...
  public static String encrypt(String key, String data) {
    ...
    try {
      ...
      cipher.init(Cipher.ENCRYPT_MODE, new SecretKeySpec(Arrays.copyOf(key.getBytes(), 1 << 5), "AES"));
  ...
  public static String decrypt(String key, String data) {
    ...
    try {
      Cipher cipher = Cipher.getInstance("AES");
      cipher.init(Cipher.DECRYPT_MODE, new SecretKeySpec(Arrays.copyOf(key.getBytes(), 1 << 5), "AES"));
