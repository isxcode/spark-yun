  ...
  <BlockModal :model-config="modelConfig">
    <el-form ref="form" class="add-computer-group" label-position="top" :model="formData" :rules="rules">
      ...
      <el-form-item label="Host" prop="host">
        <el-input v-model="formData.host" placeholder="请输入" show-word-limit />
      </el-form-item>
      <el-form-item label="Port" prop="port">
        <el-input v-model="formData.port" placeholder="请输入" show-word-limit />
      </el-form-item>
      ...
      <el-form-item label="YunHome" prop="agentHomePath">
        <el-input v-model="formData.agentHomePath" maxlength="100" placeholder="请输入" show-word-limit />
      </el-form-item>
      <el-form-item label="YunPort" prop="agentPort">
        <el-input v-model="formData.agentPort" maxlength="20" placeholder="请输入" show-word-limit />
      </el-form-item>
      <el-form-item label="Hadoop" prop="hadoopHomePath">
        <el-input v-model="formData.hadoopHomePath" maxlength="100" placeholder="请输入" show-word-limit />
      </el-form-item>
      <el-form-item label="备注">
        <el-input v-model="formData.comment" show-word-limit type="textarea" maxlength="200" :autosize="{ minRows: 4, maxRows: 4 }" placeholder="请输入" />
      </el-form-item>
    </el-form>
  </BlockModal>
</template>
