  ...
  <BlockModal :model-config="modelConfig">
    <el-form ref="form" class="add-computer-group" label-position="top" :model="formData" :rules="rules">
      ...
      <el-form-item label="成员数">
        <el-input-number v-model="formData.maxMemberNum" :min="0" :max="100" :controls="false" />
      </el-form-item>
      <el-form-item label="作业流数">
        <el-input-number v-model="formData.maxWorkflowNum" :min="0" :max="100" :controls="false" />
      </el-form-item>
      <el-form-item v-if="renderSence === 'new'" label="管理员" prop="adminUserId">
