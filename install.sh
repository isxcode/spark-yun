...
SPARK_MIN_DOWNLOAD_URL=https://isxcode.oss-cn-shanghai.aliyuncs.com/zhiqingyun/spark-3.4.0-bin-hadoop3.tgz
...
if [ ! -f "${SPARK_MIN_DIR}"/jars/spark-sql-kafka-0-10_2.12-3.4.0.jar ]; then
  ...
  curl -ssL https://isxcode.oss-cn-shanghai.aliyuncs.com/zhiqingyun/spark-sql-kafka-0-10_2.12-3.4.0.jar -o ${SPARK_MIN_DIR}/jars/spark-sql-kafka-0-10_2.12-3.4.0.jar
...
if [ ! -f "${SPARK_MIN_DIR}"/jars/kafka-clients-3.1.2.jar ]; then
  ...
  curl -ssL https://isxcode.oss-cn-shanghai.aliyuncs.com/zhiqingyun/kafka-clients-3.1.2.jar -o ${SPARK_MIN_DIR}/jars/kafka-clients-3.1.2.jar
...
if [ ! -f "${SPARK_MIN_DIR}"/jars/spark-streaming-kafka-0-10_2.12-3.4.0.jar ]; then
  ...
  curl -ssL https://isxcode.oss-cn-shanghai.aliyuncs.com/zhiqingyun/spark-streaming-kafka-0-10_2.12-3.4.0.jar -o ${SPARK_MIN_DIR}/jars/spark-streaming-kafka-0-10_2.12-3.4.0.jar
...
if [ ! -f "${SPARK_MIN_DIR}"/jars/spark-token-provider-kafka-0-10_2.12-3.4.0.jar ]; then
  ...
  curl -ssL https://isxcode.oss-cn-shanghai.aliyuncs.com/zhiqingyun/spark-token-provider-kafka-0-10_2.12-3.4.0.jar -o ${SPARK_MIN_DIR}/jars/spark-token-provider-kafka-0-10_2.12-3.4.0.jar
...
if [ ! -f "${SPARK_MIN_DIR}"/jars/commons-pool2-2.11.1.jar ]; then
  ...
  curl -ssL https://isxcode.oss-cn-shanghai.aliyuncs.com/zhiqingyun/commons-pool2-2.11.1.jar -o ${SPARK_MIN_DIR}/jars/commons-pool2-2.11.1.jar
...
if [ ! -f "${JDBC_DIR}"/mysql-connector-j-8.1.0.jar ]; then
  ...
  curl -ssL https://isxcode.oss-cn-shanghai.aliyuncs.com/zhiqingyun/mysql-connector-j-8.1.0.jar -o ${JDBC_DIR}/mysql-connector-j-8.1.0.jar
...
if [ ! -f "${JDBC_DIR}"/postgresql-42.6.0.jar ]; then
  ...
  curl -ssL https://isxcode.oss-cn-shanghai.aliyuncs.com/zhiqingyun/postgresql-42.6.0.jar -o ${JDBC_DIR}/postgresql-42.6.0.jar
...
if [ ! -f "${JDBC_DIR}"/Dm8JdbcDriver18-8.1.1.49.jar ]; then
  ...
  curl -ssL https://isxcode.oss-cn-shanghai.aliyuncs.com/zhiqingyun/Dm8JdbcDriver18-8.1.1.49.jar -o ${JDBC_DIR}/Dm8JdbcDriver18-8.1.1.49.jar
...
if [ ! -f "${JDBC_DIR}"/clickhouse-jdbc-0.5.0.jar ]; then
  ...
  curl -ssL https://isxcode.oss-cn-shanghai.aliyuncs.com/zhiqingyun/clickhouse-jdbc-0.5.0.jar -o ${JDBC_DIR}/clickhouse-jdbc-0.5.0.jar
...
if [ ! -f "${JDBC_DIR}"/ngdbc-2.18.13.jar ]; then
  ...
  curl -ssL https://isxcode.oss-cn-shanghai.aliyuncs.com/zhiqingyun/ngdbc-2.18.13.jar -o ${JDBC_DIR}/ngdbc-2.18.13.jar
...
if [ ! -f "${JDBC_DIR}"/mysql-connector-java-5.1.49.jar ]; then
  ...
  curl -ssL https://isxcode.oss-cn-shanghai.aliyuncs.com/zhiqingyun/mysql-connector-java-5.1.49.jar -o ${JDBC_DIR}/mysql-connector-java-5.1.49.jar
...
if [ ! -f "${JDBC_DIR}"/mssql-jdbc-12.4.2.jre8.jar ]; then
  ...
  curl -ssL https://isxcode.oss-cn-shanghai.aliyuncs.com/zhiqingyun/mssql-jdbc-12.4.2.jre8.jar -o ${JDBC_DIR}/mssql-jdbc-12.4.2.jre8.jar
...
if [ ! -f "${JDBC_DIR}"/hive-jdbc-3.1.3-standalone.jar ]; then
  ...
  curl -ssL https://isxcode.oss-cn-shanghai.aliyuncs.com/zhiqingyun/hive-jdbc-3.1.3-standalone.jar -o ${JDBC_DIR}/hive-jdbc-3.1.3-standalone.jar
...
if [ ! -f "${JDBC_DIR}"/hive-jdbc-uber-2.6.3.0-235.jar ]; then
  ...
  curl -ssL https://isxcode.oss-cn-shanghai.aliyuncs.com/zhiqingyun/hive-jdbc-uber-2.6.3.0-235.jar -o ${JDBC_DIR}/hive-jdbc-uber-2.6.3.0-235.jar
...
if [ ! -f "${JDBC_DIR}"/ojdbc10-19.20.0.0.jar ]; then
  ...
  curl -ssL https://isxcode.oss-cn-shanghai.aliyuncs.com/zhiqingyun/ojdbc10-19.20.0.0.jar -o ${JDBC_DIR}/ojdbc10-19.20.0.0.jar
...
if [ ! -f "${JDBC_DIR}"/oceanbase-client-2.4.6.jar ]; then
  ...
  curl -ssL https://isxcode.oss-cn-shanghai.aliyuncs.com/zhiqingyun/oceanbase-client-2.4.6.jar -o ${JDBC_DIR}/oceanbase-client-2.4.6.jar
...
if [ ! -f "${JDBC_DIR}"/jcc-11.5.8.0.jar ]; then
  ...
  curl -ssL https://isxcode.oss-cn-shanghai.aliyuncs.com/zhiqingyun/jcc-11.5.8.0.jar -o ${JDBC_DIR}/jcc-11.5.8.0.jar
...
if [ ! -f "${BASE_PATH}"/spark-yun-backend/spark-yun-main/src/main/resources/libprql_java-osx-arm64.dylib ]; then
  ...
  curl -ssL https://isxcode.oss-cn-shanghai.aliyuncs.com/zhiqingyun/libprql_java-osx-arm64.dylib -o ${BASE_PATH}/spark-yun-backend/spark-yun-main/src/main/resources/libprql_java-osx-arm64.dylib
...
if [ ! -f "${BASE_PATH}"/spark-yun-backend/spark-yun-main/src/main/resources/libprql_java-linux64.so ]; then
  ...
  curl -ssL https://isxcode.oss-cn-shanghai.aliyuncs.com/zhiqingyun/libprql_java-linux64.so -o ${BASE_PATH}/spark-yun-backend/spark-yun-main/src/main/resources/libprql_java-linux64.so
