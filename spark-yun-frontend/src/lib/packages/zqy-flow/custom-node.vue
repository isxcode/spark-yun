            ...
            <el-dropdown v-if="showMenu" trigger="click" @command="handleCommand">
                ...
                <template #dropdown>
                    <el-dropdown-menu>
                        ...
                        <el-dropdown-item v-if="status === 'SUCCESS' && ['QUERY_JDBC', 'SPARK_CONTAINER_SQL'].includes(node.data.nodeConfigData.workType)" command="node_result">运行结果</el-dropdown-item>
