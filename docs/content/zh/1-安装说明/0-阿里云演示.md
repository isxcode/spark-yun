...
访问接口：http://47.92.206.49:8080 <div/>
管理员账号：`admin` <div/>
管理员密码：`admin123`
...
类型: `Mysql` <div/>
链接信息: `jdbc:mysql://47.92.206.49:30306/test_db` <div/>
用户名: `root` <div/>
密码: `zhiqingyun123`
...
自定义函数参考模版地址： https://github.com/isxcode/spark-function-template <div/>
演示函数下载：https://openfly.oss-cn-shanghai.aliyuncs.com/spark-custom-func.jar <div/>
...
自定义作业参考模版地址：https://github.com/isxcode/spark-job-template <div/>
