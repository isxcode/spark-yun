...
注意： on k8s模式访问hive或者hdfs中的数据，容器需要做域名映射，需要添加额外配置

```json
{
  "qing.hive.username": "ispong",
  "qing.host1.name": "isxcode-dev",
  "qing.host1.value": "172.123.139.227"
}   
```
...
> 自定义作业参考链接: https://github.com/ispong/spark-job-template
