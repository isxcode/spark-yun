...
- **clientSecret**: 必填，单点的clientSecret，对应的认证平台获取
- **scope**: 非必填，单点参数，根据对应的平台推荐填写，如果是Keycloak类型，推荐填写`openid`
...
- [Keycloak安装文档参考](https://ispong.isxcode.com/spring/spring/spring%20Keycloak%E9%9B%86%E6%88%90/)
...
scope： openid
redirectUrl：http://xxx/ssoauth?clientId=${clientId}
authJsonPath: `$.preferred_username`
