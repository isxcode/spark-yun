...
[点击下载官网OpenJdk](https://cdn.azul.com/zulu/bin/zulu17.66.19-ca-jdk17.0.19-linux_x64.tar.gz)

```bash
# 推送到服务器
scp zulu17.66.19-ca-jdk17.0.19-linux_x64.tar.gz root@47.116.163.22:/tmp/
```
...
```bash
tar -vzxf /tmp/zulu17.66.19-ca-jdk17.0.19-linux_x64.tar.gz -C /opt
