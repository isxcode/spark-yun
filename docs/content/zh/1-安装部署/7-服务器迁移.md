...
```bash
scp /Users/ispong/OneDrive/Downloads/linux/java/zulu17.66.19-ca-jdk17.0.19-linux_x64.tar.gz root@127.0.0.1:/tmp
...
EOF
source ~/.bashrc
rm -f /tmp/zulu17.66.19-ca-jdk17.0.19-linux_x64.tar.gz
java -version
```
