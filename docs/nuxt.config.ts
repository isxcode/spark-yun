export default defineNuxtConfig({
  ...
  routeRules: {
    ...
    "/guide/writing/content-directory": {
      redirect: "/usage/content-directory",
    },
    ...
    "/guide/writing/document-driven": {
      redirect: "/document-driven/introduction",
    },
    "/guide/writing/vue-components": {
      redirect: "/usage/markdown#vue-components",
    },
    ...
    "/api/components/content-renderer": {
      redirect: "/components/content-renderer",
    },
    "/api/components/content-navigation": {
      redirect: "/components/content-navigation",
    },
    ...
    "/api/composables/query-content": {
      redirect: "/composables/query-content",
    },
    "/api/composables/fetch-content-navigation": {
      redirect: "/composables/fetch-content-navigation",
    },
    "/api/composables/unwrap": { redirect: "/composables/use-unwrap" },
    "/api/composables/use-document-driven": {
      redirect: "/document-driven/use-content",
    },
    "/api/composables/use-content-helpers": {
      redirect: "/composables/use-content-helpers",
    },
    "/api/composables/use-content-head": {
      redirect: "/composables/use-content-head",
    },
